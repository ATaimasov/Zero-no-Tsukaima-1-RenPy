translate russian strings:
    ...
    old "Well, of course YOU had a great time. You were going all lovey-dovey with every girl in sight..."
    new "Ну конечно, тебе-то было весело. Ты же вокруг каждой встречной девушки вилял хвостом…"

    old "Really, nothing could be more unseemly!"
    new "Что за позор — слов нет!"

    old "I wasn't being all lovey-dovey or anything! Wait… could it be you're jealous?"
    new "Да не вилял я хвостом ни перед кем! Постой… неужели ты ревнуешь?"

    old "Th-th-that's ridiculous, of course not!"
    new "Ч-ч-что за ерунда, конечно же нет!"

    old "If my stupid familiar goes around causing trouble everywhere, it'll reflect badly on me—your master! It's not like I'm jealous or anything, okay!"
    new "Если этот придурковатый фамильяр начнёт творить беспредел повсюду, то и хозяйке достанется — вот и всё! И вовсе я не ревную, ясно?!"

    old "Is that so, huh?"
    new "Вот как, значит?!"

    old "That's exactly right!"
    new "Именно так!"

    old "Still, she went on a bit of a weird clothes-shopping spree this time. And it takes forever to pick anything out... Honestly, I was just killing time the whole way through..."
    new "И всё же, на этот раз она как-то странно много одежды накупила. Да ещё и выбирает так долго… Честно, я просто изнывал от скуки…"
    ...
    old "It's nothing, really! I've been making sure you eat properly these days, so the least you can do is obediently listen to your master!"
    new "Неважно! Я, между прочим, тебя в последнее время регулярно кормлю, так что изволь слушаться свою хозяйку когда она тебе что-то говорит!"
    ...
    old "N-no, nothing at all!"
    new "Н-нет, ничего!"

    old "Hah hah haa! Still getting bossed around by her, huh, partner?"
    new "Ха-ха-хаа! Всё ещё под каблуком, а, приятель?"

    old "I do NOT boss him around!"
    new "Не под каблуком он!"
    ...
    old "See, a mage and their familiar—they're one-of-a-kind partners, that's the thing. So you two getting along? That's a good thing, y'know!"
    new "Понимаете, маг и фамилиар — они, знаете ли, партнёры единственные в своём роде. Так что когда вы ладите друг с другом — это только к лучшему, вот что я вам скажу!"

    old "Besides, when a noble young lady goes out of her way to dress up for her partner's sake — that's quite the gesture, y'know!"
    new "Да и потом, сама благородная девица говорит, что хочет принарядиться ради своего напарника — это ж дорогого стоит, понимаешь!"

    old "C'mon, partner — a real man at least offers a gentle word when it counts, yeah?"
    new "Эй, партнёр — настоящий мужик хоть тёплое слово обронит, когда надо, разве нет?"

    # !!!
    old "See? That’s it. A real man knows to offer a gentle word when it counts—that’s what being a man’s all about, huh?"
    new "Видишь? Настоящий мужик знает, когда тёплое слово обронить — в этом и есть мужская суть!"

    old "If you run your mouth one more time, I'll melt you down into scrap iron and bury you in the academy's backyard — got it?!"
    new "Ещё хоть слово скажешь — расплавлю, превращу в железный лом и зарою в заднем дворе академии, ясно?!"

    old "Whoa, scary! Partner, I'll just take a little nap for now — so when my cue comes, give me a holler, yeah?"
    ...
    new "Правда? Прости, Сиеста. Мне жаль, что доставляю тебе столько хлопот."

    old "Really, I know I'm causing you extra trouble because of Saito, but I'm counting on you."
    new "Правда, из-за Сайто я доставляю тебе лишние хлопоты, но рассчитываю на тебя."
    ...
    new "Эй, да подожди ты! Не тяни меня так сильно! Ой, больно, больно! Я же сказал, что больно!"
    ...
    new "Ах, ах, ах, неужели это правда?"

    old "Yeah, it's got absolutely nothing to do with it."
    new "Ага, это вообще ни при чём."
    ...
    new "Конечно. Не надо объяснять очевидное."
    ...
    new "Ах, так это та горничная?"

    old "Thaaat's wroong tooo!"
    new "Э-э-то то-о-же не-е-пра-а-вда!"
    ...
    new "Я смогу присматривать за ней только в свободное от работы время, но я возьму это на себя. Так что, пожалуйста,  ложитесь спать и не переживайте, Сайто-сан."
    ...
    new "Но пока что я вообще не понимаю, что тут происходит."
    ...
    new "Извини, что пришел так поздно. Ну ладно, до завтра."

    old "Ah, right. Good night, Saito-san."
    new "А, хорошо. Спокойной ночи, Сайто-сан."

    old "Ah, good night, Siesta."
    new "А, спокойной ночи, Сиеста."

    old "I don't think it's a coincidence. I doubt there are many people in the same circumstances as me."
    new "Думаю, это не совпадение. Вряд ли найдётся много людей в таком же положении, как у меня."

    old "I wonder... I don't really understand it myself either."
    new "Кто его знает. Я и сам толком не понимаю."
    ...
    new "Как и у Сиесты, есть вероятность, что её дедушка или отец были из той же страны, что и я. Но не спросишь — не узнаешь."
    ...
    new "Никаких «ну и дела». Отдыхать будешь, когда закончишь работу!"

    old "What!? That's not fair, wifey!?"
    new "Эээ!? Ну это уже перебор, хозяюшка!?"

    old "Who are you calling wifey!"
    new "Какая ещё хозяюшка!"

    old "Did you do the laundry? Did you clean your room? Did you put away the things you bought?"
    new "Одежду постирал? В комнате убрал? Покупки на место убрал?"

    old "Ah, geez, don't dump it all on me at once! I can't possibly finish that many chores in one go."
    new "А, блин, не вываливай всё сразу! Я же не могу столько дел за раз переделать."

    old "Then stop talking and get to work! No rest until you're done!"
    new "Тогда нечего болтать — за работу! Пока не управишься, отдыха не будет!"
    ...
    new "Ну, тогда за работу. Ты ещё не закончил свои дела, так что давай, начинай побыстрее!"

    old "Wh-what the hell! Then don't talk to me!"
    new "Ч-что?! Тогда не лезь ко мне с разговорами!"

    old "Shut up, shut up! Hurry up and do your work!"
    new "Да заткнись уже! Быстрее за работу!"
    ...
    new "Видимо, я уже выполнил всё, что должен был сделать в этом мире."
    ...
    new "В чём дело, напарник? Что тебе от меня нужно в такую рань?"
    ...
    new "Погоди, а это ещё что? Крутишь тайный роман с деревенской девчонкой прямо в покоях аристократки? Ну ты и сорвиголова, напарник, как всегда не дорожишь своей головой."

    old "W-What!? No, I'm not mentally ready for something like that!"
    new "Э-э-э!? Нет, я еще морально не готова к такому!"

    old "That's not it! Don't say things that will be completely misunderstood!"
    new "Неправда! Не говори вещи, которые можно так превратно понять!"

    old "Tch, what a drag. Anyway, what do you really need?"
    new "Тьфу, неинтересно. Ладно, и чего ты от меня на самом деле хочешь?"
    ...
    new "Прошу тебя. На кону стоит моя честь."

    old "My, my. You're as stubbornly by-the-book as always, partner. Oh well, whatever."
    new "Ну надо же. Всё такой же принципиальный, напарник. Ну, ладно уж."

    old "The noble girl gave my partner permission to use the bed."
    new "Знатная барышня разрешила моему напарнику воспользоваться кроватью."
    ...
    new "Ну, само собой. Хотя с какими именно нечистыми помыслами мой напарник забрался в эту кровать — это уже не моя забота."

    old "Like I said! Stop adding unnecessary commentary!"
    new "Я же говорил! Не добавляй лишних подробностей!"
    ...
    new "Правда!? Понял, сейчас же иду!"

    old "Eh, ah, wait a sec, Saito!? Wait until I get changed!!"
    new "Э, а, постой, Сайто!? Подожди, пока я переоденусь!!"
    ...
    new "Слушай, Табита. Почему ты здесь?"

    old "Hey, Siesta. Why are there so many people here?"
    new "Слушай, Сиеста. Почему здесь так много людей?"

    old "Hey, Louise. Why are there so many people here?"
    new "Слушай, Луиза. Почему здесь так много людей?"
